...
class Test extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`http://localhost:8001/locations`).then(response => {
      ...
      this.setState({properties: response.data, filteredDataList: response.data})
    })
  }
  ...
  handleClear(e) {
    e.preventDefault()
    this.setState({filteredDataList: this.state.properties})
  }
      ...
      <div className="testContainer">
        <div className="filterContainer">
          <form onSubmit={this.handleSubmit.bind(this)}>
            Beds:
            <input id="txtBed" name="beds" type="text" placeholder="beds" onChange={this._onFilterChange.bind(this)}/>
            Baths:
            <input id="txtBath" name="baths" type="text" placeholder="baths" onChange={this._onFilterChange.bind(this)}/>
